      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <main className="container mx-auto px-6 flex-1 flex items-center justify-center">
          <div className="max-w-4xl mx-auto text-center py-12">
            ...
            <motion.h1
              className="text-5xl md:text-6xl lg:text-7xl mb-8 bg-gradient-to-r from-purple-600 via-pink-600 to-purple-600 bg-clip-text text-transparent leading-tight"
            ...
            >
              A modern email client built for productivity. Smart automation, intuitive design, and powerful features to help you focus on what matters.
            </motion.p>
            ...
            >
              <Button
                size="lg"
                className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white px-10 py-6 text-lg shadow-lg hover:shadow-xl transition-all duration-300"
              >
                Get Started
              </Button>
            </motion.div>
